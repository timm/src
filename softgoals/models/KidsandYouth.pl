...
helpBeAcquired<--[or, useAskACounsellorSection, useCyberCafPortalChatRoom, usePhoneCounselling, useVideoCounselling, useEmailCounselling, useVoiceCounselling, useTextMessaging, useOneOnOneChatRooms].
...
informationBeAcquiredOnWebsite<--[or, readPollsAboutKids, readGeneralQuestionsAndAnswers, readGetInformedSectionOfWebSite].
