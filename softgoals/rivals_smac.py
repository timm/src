#!/usr/bin/env python3
# rivals_smac.py : SMAC3 (HyperparameterOptimizationFacade, random
# forest surrogate) over the softgoals corpus. Same protocol as
# rivals_optuna.py: leaves as t/f categoricals, objective = mean
# d2h of 3 replayed worlds, yardstick from 1000 untreated worlds.
# Run under the venv that has smac: ~/tmp/smacenv/bin/python
