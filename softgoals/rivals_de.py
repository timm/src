#!/usr/bin/env python3
# rivals_de.py : binary differential evolution over the softgoals
# corpus. Same budget/space/objective as rivals_optuna.py (500
# evals x 3 worlds, leaves t/f, mean replayed d2h, dead=2.0).
# Hypothesis under test: offspring of surviving parents hit the
# feasible region more often than independent sampling, so DE
# should show a rising alive%% across generations where TPE just
# drowns.  Reports alive%% of gen-1 vs last-gen offspring.
